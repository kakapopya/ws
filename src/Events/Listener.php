...
class Listener
{
     ...
     *
     * @return \Lambq\Ws\Events\Listener
     */
    ...
    /**
     * Binds events to the WsEventsManager
     * @param  \WsEventsManager $manager
     * @return \Lambq\Ws\Events\Listener
     */
    protected function registerEvents(WsEventsManager $manager)
    {
