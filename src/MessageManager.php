...
use stdClass;
use Lambq\Ws\Media\VCard;
use Lambq\Ws\Media\Media;
use Lambq\Ws\Media\VCardReader;
...
class MessageManager
{
     ...
     * Constructor
     *
     * @param \Lambq\Ws\Media\Media $media
     */
     ...
     *
     *         // From local storage
     *         $send->audio('/home/Lambq/example.mp3');
     *
     *         // or from web url
     ...
     *
     *         // From local storage
     *         $send->image('/home/Lambq/example.jpg', 'Cool image');
     *
     *         // or from web url
     ...
     *     $vcard = new Lambq\Ws\Media\VCard();
     *
     *     // Set properties
     ...
     *
     *     // Send
     *     WA::send('Hi, meet to Lambq !', function($send) use ($vcard)
     *     {
     *         $send->to('5219622222222');
     *         $send->vcard('Lambq Mat', $vcard);
     *     }):
     * </code>
     *
     ...
     *
     *         // From local storage
     *         $send->video('/home/Lambq/example.mp4', 'Fun video');
     *
     *         // or from web url
